...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/dclrcoin-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    {
       nSubsidy = 560000000 * COIN; // 560,000,000 Premine
    }   
    else if(nHeight<=2000)
    {
        nSubsidy = 64000 * COIN; // 12,793,600
    }
    else if(nHeight<=4000)
    {
        nSubsidy = 3200 * COIN; // 6,400,000
    }
    else if(nHeight<=8000)
    {
        nSubsidy = 1600 * COIN; // 6,400,000
    }  
    else if(nHeight<=16000)
    {
        nSubsidy = 800 * COIN; // 6,400,000
    }  
    else if(nHeight<=32000)
    {
        nSubsidy = 400 * COIN; // 6,400,000
    }
    else if(nHeight<=64000)
    {
        nSubsidy = 200 * COIN; // 6,400,000
    } 
    else if(nHeight<=128000)
    {
        nSubsidy = 100 * COIN; // 6,400,000
    } 
    else if(nHeight<=987904128)
    {
        nSubsidy = 50 * COIN; // 49,388,806,400
    }   
    else
    {
        nSubsidy = 0 * COIN;
