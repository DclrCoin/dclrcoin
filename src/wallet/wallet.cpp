...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/dclrcoin/dclrcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/dclrcoin/dclrcoin/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g dclrcoin-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/dclrcoin/dclrcoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-dclrcoin-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g dclrcoin-wallet), tx confirmation
 ...
 * https://dclrcointalk.org/?topic=54527, or
 * https://github.com/dclrcoin/dclrcoin/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //DCLRTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeDCLRs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeDCLRs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeDCLRs(true, connman, mempool);
}
