    ...
    mapper(nullptr)
{
    ...
    ui->dclrcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->dclrcoinAtStartup);
    ...
    ui->dclrcoinAtStartup->setToolTip(ui->dclrcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->dclrcoinAtStartup->setText(ui->dclrcoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->dclrcoinAtStartup, OptionsModel::StartAtStartup);
