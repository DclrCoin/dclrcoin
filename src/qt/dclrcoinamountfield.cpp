...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::DCLR, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    int currentUnit{BitcoinUnits::DCLR};
...
#include <qt/dclrcoinamountfield.moc>
