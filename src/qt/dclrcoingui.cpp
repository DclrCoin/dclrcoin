...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DCLRcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and DCLRcoin : URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DCLRcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DCLRcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a dclrcoin: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to DCLRcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
