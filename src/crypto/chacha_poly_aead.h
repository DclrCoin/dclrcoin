...
/* A AEAD class for ChaCha20-Poly1305@dclrcoin.
 *
 ...
 *
 * The chacha20-poly1305@dclrcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@dclrcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@dclrcoin are relatively fast in
