...
const char * const BITCOIN_CONF_FILENAME = "dclrcoin.conf";
 ...
 * https://github.com/dclrcoin/dclrcoin/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //dclrcoin-tx using stdin
        std::string val;
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\DCLRcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\DCLRcoin
    // Mac: ~/Library/Application Support/DCLRcoin
    // Unix: ~/.dclrcoin
#ifdef WIN32
    // Windows
