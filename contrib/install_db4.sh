...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the dclrcoin repository."
  exit 1
fi
...
# See https://github.com/dclrcoin/dclrcoin/issues/16064
...
echo 'When compiling dclrcoind, run `./configure` in the following way:'
echo
