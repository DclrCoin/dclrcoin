...
(define* (make-dclrcoin-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-dclrcoin-cross-toolchain "i686-linux-gnu")
       (make-dclrcoin-cross-toolchain "x86_64-linux-gnu")
       (make-dclrcoin-cross-toolchain "aarch64-linux-gnu")
       (make-dclrcoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-dclrcoin-cross-toolchain "riscv64-linux-gnu"
