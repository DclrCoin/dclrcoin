...
// dclrcoin includes.
#include <..\src\script\dclrcoinconsensus.h>
...
int main()
{
    std::cout << "dclrcoinconsensus version: " << dclrcoinconsensus_version() << std::endl;
    ...
    auto op0Result = dclrcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, dclrcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
