Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://dclrcoin.org/bin/dclrcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update dclrcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow dclrcoin-tx to create v2 transactions (BTCdrak)
