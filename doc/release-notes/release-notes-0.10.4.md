Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://dclrcoin.org/bin/dclrcoin-core-0.10.4/>
...
- #6953 `43c2789` Split dclrcoin-tx into its own package
- #6953 `dfe0d4d` Include dclrcoin-tx binary on Debian/Ubuntu
