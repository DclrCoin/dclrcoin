Bitcoin Core version 0.16.1 is now available from:
  ...
  <https://dclrcoincore.org/bin/dclrcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting dclrcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure dclrcoind processes are cleaned up when tests end (sdaftuar)
