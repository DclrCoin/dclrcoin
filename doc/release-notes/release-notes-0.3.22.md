Download URL: https://sourceforge.net/projects/dclrcoin/files/Bitcoin/dclrcoin-0.3.22/
...
* IRC is overflowing.  Client now bootstraps to channels #dclrcoin00 - #dclrcoin99
