Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://dclrcoin.org/bin/dclrcoin-core-0.11.0/>
...
For example, add the following to `dclrcoin.conf`:
...
related to the blockchain in the dclrcoin system: the raw blocks as received over 
...
For an example script see [dclrcoin-submittx](https://github.com/laanwj/dclrcoin-submittx).
...
- #5334 `cf87536` libdclrcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new dclrcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add dclrcoin logo to about screen
...
- #5809 `46bfbe7` Add dclrcoin-cli man page
...
- #5849 `41259ca` contrib/init/dclrcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for dclrcoin-tx)
