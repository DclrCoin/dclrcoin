Bitcoin Core version 0.13.0 is now available from:
  ...
  <https://dclrcoin.org/bin/dclrcoin-core-0.13.0/>
...
updates will be released anymore. Without security updates, using a dclrcoin
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of Bitcoin Core
randomly crashing on Windows XP. It is [not clear](https://github.com/dclrcoin/dclrcoin/issues/7681#issuecomment-217439891)
...
- Adding `dbcache=100` in dclrcoin.conf
...
dclrcoin-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/dclrcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
- `dclrcoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `dclrcoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
compatible peers.
[BIP 152](https://github.com/dclrcoin/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/dclrcoin/dclrcoin/pull/8035/files), [BIP 32](https://github.com/dclrcoin/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/dclrcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/dclrcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/dclrcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/dclrcoin/bips/blob/master/bip-0145.mediawiki) are
...
Witness)] (https://github.com/dclrcoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/dclrcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/dclrcoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/dclrcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/dclrcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/dclrcoin/dclrcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for dclrcoin-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to dclrcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add dclrcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: dclrcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from dclrcoind (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for dclrcoind procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of dclrcoind startup (laanwj)
...
- #7975 `fc23fee` Update dclrcoin-core GitHub links (MarcoFalke)
