Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/dclrcoin/files/Bitcoin/dclrcoin-0.7.0/

We recommend that everybody running prior versions of dclrcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/dclrcoin/dclrcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/dclrcoin/dclrcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the dclrcoin-qt package:
  sudo apt-get install dclrcoin-qt
...
Core dclrcoin handling and blockchain database
...
* Ensure a changed dclrcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for dclrcoin-qt.exe
* (Windows only): add meta-data to dclrcoin-qt.exe (e.g. description)
...
* Bash programmable completion for dclrcoind(1)
