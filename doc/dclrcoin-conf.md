# `dclrcoin.conf` Configuration File
...
-- | -- | --
Windows | `%APPDATA%\Bitcoin\` | `C:\Users\username\AppData\Roaming\Bitcoin\dclrcoin.conf`
Linux | `$HOME/.dclrcoin/` | `/home/username/.dclrcoin/dclrcoin.conf`
macOS | `$HOME/Library/Application Support/Bitcoin/` | `/Users/username/Library/Application Support/Bitcoin/dclrcoin.conf`
