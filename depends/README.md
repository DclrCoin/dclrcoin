...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_dclrcoin` executable (see https://github.com/dclrcoin/dclrcoin/pull/13543),
...
options will be passed to dclrcoin's configure. In this case, `--disable-wallet`.
