...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # node0 should end up with 100 DCLR in block rewards plus fees, but
        ...
        # This will raise an exception for attempting to get the private key of an invalid DCLRcoin address
        assert_raises_rpc_error(-5, "Invalid DCLRcoin address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid DCLRcoin address
        assert_raises_rpc_error(-5, "Invalid DCLRcoin address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid DCLRcoin address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/dclrcoin/dclrcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
