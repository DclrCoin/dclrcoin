...
"""Verify that starting dclrcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dclrcoin with -h for help text")
        ...
        self.log.info("Start dclrcoin with -version for version information")
        ...
        self.log.info("Start dclrcoind with -fakearg to make sure it does not start")
