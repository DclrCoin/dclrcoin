...
# TestP2PConn: A peer we use to send messages to dclrcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    def test_sendcmpct(self, test_node, old_node=None):
        ...
        # Make sure we get a SEDCLRMPCT message from our peer
        ...
        # Now try a SEDCLRMPCT message with too-high version
        ...
        # Now try a SEDCLRMPCT message with valid version, but announce=False
        ...
        # Finally, try a SEDCLRMPCT message with announce=True
        sendcmpct.version = preferred_version
        sendcmpct.announce = True
        test_node.send_and_ping(sendcmpct)
    ...
    # This test actually causes dclrcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that dclrcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for dclrcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # dclrcoind will not send blocktxn responses for blocks whose height is
    ...
    def run_test(self):
        ...
        self.log.info("Testing SEDCLRMPCT p2p message... ")
