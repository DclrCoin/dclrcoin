...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.dclrcoind,
            self.options.dclrcoind,
            releases_path + "/v0.19.0.1/bin/dclrcoind",
            releases_path + "/v0.18.1/bin/dclrcoind",
            releases_path + "/v0.17.1/bin/dclrcoind"
        ], binary_cli=[
            self.options.dclrcoincli,
            self.options.dclrcoincli,
            releases_path + "/v0.19.0.1/bin/dclrcoin-cli",
            releases_path + "/v0.18.1/bin/dclrcoin-cli",
            releases_path + "/v0.17.1/bin/dclrcoin-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes dclrcoind to exit, in addition to the RPC
